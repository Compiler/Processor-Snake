...
public void draw(){
  ...
  public void spawnByDifficulty(String difficultyyy){
    switch(difficultyyy){
    case "Easy": {
     spawnTimer = 100;
     break;
...
public void drawGameOverScene(){
    ...
    textFont(mono);
    textAlign(CENTER);
    text("SCORE:" + x.size(), width / 2, height / 1.75f);
    ...
    if(frameSec > 300){
      ...
      textAlign(CENTER);
      text("Press R to continue", width / 2, height / 1.5f);
    }
...
public void keyPressed(){
  ...
  public void checkCollisionWithSelf(){
